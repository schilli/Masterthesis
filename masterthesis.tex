...
\paragraph{Citrate Parameterization}
...
Citrate, the three water molcecules and the sodium ion to be included in the starting structure have been modelled into the homology model structure.
This was basically done by superimposing the model and the template and then copying the coordinates over.
...
Chain B was chosen above chain A, as the protein is known to be monomeric in solution and because chain B hadthe smaller RMSD when compared to the BSLA entries in the PDB with covalently bound ligands (\PDB{1ISP}, \PDB{1R4Z} and \PDB{1R50}).
