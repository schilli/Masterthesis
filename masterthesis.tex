...
Two common strategies to analyse large amounts of high dimensional data are the reduction of the number of datapoints to get insight into the most important features of a dataset and the reduction of the number of dimensions of the feature space for easier representations and classification.
If there is reason to assume that the datapoints at hand can be categorized in spatially seperated groups in feature space it
